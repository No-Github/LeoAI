...
public class DockerContainerController {
    ...
    public HashMap<String, Object> listContainers(@RequestBody HashMap<String, Object> params) {
        ...
        return ControllerUtil.handleCapabilityCall(params, DockerCapable.class, "获取容器列表失败", node -> node.listDockerContainers(all));
    }
    ...
    public HashMap<String, Object> listImages(@RequestBody HashMap<String, Object> params) {
        return ControllerUtil.handleCapabilityCall(params, DockerCapable.class, "获取镜像列表失败", node -> node.listDockerImages());
    }
    ...
    public HashMap<String, Object> inspect(@RequestBody HashMap<String, Object> params) {
        ...
        return ControllerUtil.handleCapabilityCall(params, DockerCapable.class, "容器详情获取失败", node -> node.inspectDockerContainer(containerId));
    }
    ...
    public HashMap<String, Object> logs(@RequestBody HashMap<String, Object> params) {
        ...
        return ControllerUtil.handleCapabilityCall(params, DockerCapable.class, "获取容器日志失败", node -> node.getDockerContainerLogs(containerId, tail));
    }
    ...
    public HashMap<String, Object> listNetworks(@RequestBody HashMap<String, Object> params) {
        return ControllerUtil.handleCapabilityCall(params, DockerCapable.class, "获取网络列表失败", node -> node.listDockerNetworks());
    }

    @RequestMapping(value = "/info", method = RequestMethod.POST)
    public HashMap<String, Object> info(@RequestBody HashMap<String, Object> params) {
        return ControllerUtil.handleCapabilityCall(params, DockerCapable.class, "获取 Docker 信息失败", node -> node.getDockerInfo());
    }
    ...
    public HashMap<String, Object> exec(@RequestBody HashMap<String, Object> params) {
        ...
        return ControllerUtil.handleCapabilityCall(params, DockerCapable.class, "容器命令执行失败", node -> node.execInDockerContainer(containerId, cmd));
    }
    ...
    public HashMap<String, Object> start(@RequestBody HashMap<String, Object> params) {
        String containerId = ControllerUtil.getStr(params, "containerId");
        if (containerId == null) return ApiResponse.badRequest("containerId 参数必填");
        return ControllerUtil.handleCapabilityCall(params, DockerCapable.class, "启动容器失败", node -> node.startDockerContainer(containerId));
    }
    ...
    public HashMap<String, Object> stop(@RequestBody HashMap<String, Object> params) {
        ...
        return ControllerUtil.handleCapabilityCall(params, DockerCapable.class, "停止容器失败", node -> node.stopDockerContainer(containerId, timeout));
    }
    ...
    public HashMap<String, Object> restart(@RequestBody HashMap<String, Object> params) {
        ...
        if (containerId == null) return ApiResponse.badRequest("containerId 参数必填");
        int timeout = ControllerUtil.getInt(params, "timeout", 10);
        return ControllerUtil.handleCapabilityCall(params, DockerCapable.class, "重启容器失败", node -> node.restartDockerContainer(containerId, timeout));
    }
    ...
    public HashMap<String, Object> pause(@RequestBody HashMap<String, Object> params) {
        String containerId = ControllerUtil.getStr(params, "containerId");
        if (containerId == null) return ApiResponse.badRequest("containerId 参数必填");
        return ControllerUtil.handleCapabilityCall(params, DockerCapable.class, "暂停容器失败", node -> node.pauseDockerContainer(containerId));
    }
    ...
    public HashMap<String, Object> unpause(@RequestBody HashMap<String, Object> params) {
        String containerId = ControllerUtil.getStr(params, "containerId");
        if (containerId == null) return ApiResponse.badRequest("containerId 参数必填");
        return ControllerUtil.handleCapabilityCall(params, DockerCapable.class, "恢复容器失败", node -> node.unpauseDockerContainer(containerId));
    }
    ...
    public HashMap<String, Object> removeContainer(@RequestBody HashMap<String, Object> params) {
        ...
        return ControllerUtil.handleCapabilityCall(params, DockerCapable.class, "删除容器失败", node -> node.removeDockerContainer(containerId, force));
    }
    ...
    public HashMap<String, Object> removeImage(@RequestBody HashMap<String, Object> params) {
        ...
        boolean force = ControllerUtil.getBool(params, "force");
        return ControllerUtil.handleCapabilityCall(params, DockerCapable.class, "删除镜像失败", node -> node.removeDockerImage(imageId, force));
    }
}
