...
public class SuidCapabilityController {
    ...
    public HashMap<String, Object> listSuid(@RequestBody HashMap<String, Object> params) {
        return ControllerUtil.handleCapabilityCall(params, SuidCapabilityCapable.class, "枚举 SUID 失败", node -> node.listSuidFiles());
    }
    ...
    public HashMap<String, Object> listSgid(@RequestBody HashMap<String, Object> params) {
        return ControllerUtil.handleCapabilityCall(params, SuidCapabilityCapable.class, "枚举 SGID 失败", node -> node.listSgidFiles());
    }
    ...
    public HashMap<String, Object> listCapabilities(@RequestBody HashMap<String, Object> params) {
        return ControllerUtil.handleCapabilityCall(params, SuidCapabilityCapable.class, "枚举 Capabilities 失败", node -> node.listFileCapabilities());
    }

    @RequestMapping(value = "/all", method = RequestMethod.POST)
    public HashMap<String, Object> listAll(@RequestBody HashMap<String, Object> params) {
        return ControllerUtil.handleCapabilityCall(params, SuidCapabilityCapable.class, "枚举失败", node -> node.listAllSuidCaps());
    }
}
