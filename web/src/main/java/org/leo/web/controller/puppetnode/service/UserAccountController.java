...
public class UserAccountController {
    ...
    public HashMap<String, Object> listUsers(@RequestBody HashMap<String, Object> params) {
        return ControllerUtil.handleCapabilityCall(params, UserAccountCapable.class, "获取用户列表失败", node -> node.listUsers());
    }
    ...
    public HashMap<String, Object> listGroups(@RequestBody HashMap<String, Object> params) {
        return ControllerUtil.handleCapabilityCall(params, UserAccountCapable.class, "获取组列表失败", node -> node.listGroups());
    }
    ...
    public HashMap<String, Object> queryUser(@RequestBody HashMap<String, Object> params) {
        ...
        return ControllerUtil.handleCapabilityCall(params, UserAccountCapable.class, "查询用户失败", node -> node.queryUser(username));
    }
    ...
    public HashMap<String, Object> queryGroup(@RequestBody HashMap<String, Object> params) {
        ...
        return ControllerUtil.handleCapabilityCall(params, UserAccountCapable.class, "查询组失败", node -> node.queryGroup(groupName));
    }
    ...
    public HashMap<String, Object> whoami(@RequestBody HashMap<String, Object> params) {
        return ControllerUtil.handleCapabilityCall(params, UserAccountCapable.class, "获取当前用户信息失败", node -> node.whoami());
    }
}
