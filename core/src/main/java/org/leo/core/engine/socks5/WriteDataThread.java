...
public class WriteDataThread implements Runnable{
    ...
    public WriteDataThread(Socket clientSocket, String connId, ComponentInvokeCapable puppetNode, Socks5ProxyStatistics statistics) {
    ...
    private boolean closeRemoteSocket(String connId) {
        try {
            ...
            params.put("op", 3);
            params.put("connId", connId);
            puppetNode.invokeComponent("ProxyForwardComponent", params);
        } catch (Exception e) {
